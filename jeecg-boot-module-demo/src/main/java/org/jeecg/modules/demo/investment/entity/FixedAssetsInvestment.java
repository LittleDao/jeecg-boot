 ...
 * @Version: V1.0
 */
@ApiModel(value="fixed_assets_investment对象", description="固定资产投资表")
@Data
@TableName("fixed_assets_investment")
public class FixedAssetsInvestment implements Serializable {
